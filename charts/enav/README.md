...
| global.kafka_broker.advertised_listeners | string | `"PLAINTEXT://enav-kafka-broker.enav-service-architecture:9092,PLAINTEXT_HOST://localhost:19092"` |  |
...
| global.kafka_broker.kafka_listeners | string | `"PLAINTEXT://0.0.0.0:9092,CONTROLLER://localhost:29093,PLAINTEXT_HOST://0.0.0.0:19092"` |  |
