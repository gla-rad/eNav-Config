...
| image.repository | string | `"ghcr.io/gla-rad/enav-aton-admin-service"` |  |
| image.tag | string | `""` |  |
...
| volumes[3].projected.sources[0].secret.name | string | `"aton-admin-service-secrets"` |  |
...
| volumes[3].projected.sources[1].secret.name | string | `"aton-admin-service-secrets"` |  |
